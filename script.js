...
const isOpen = checkDistribuidoraOpen();
if(!isOpen){
    
    Toastify({
        text: "Ops a Distribuidora está Fechada!",
        duration: 3000,
        close: true,
        gravity: "top",
        position: "right",
...
function checkDistribuidoraOpen(){
const data = new Date();
const hora = data.getHours();
return hora >= 18 && horas < 4; 
//true = distribuidora etsá aberto  
}
